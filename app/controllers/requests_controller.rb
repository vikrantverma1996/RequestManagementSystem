class RequestsController < ApplicationController
  ...
  private
    ...
    def request_params
      params.require(:request).permit(:title, :description,:status, :attachment, :expected_date, :key_parameter, :cycle_time_reduction, :man_power_reduction,:it_actual_date,:remarks,:it_status,:team_members)
    end
end
